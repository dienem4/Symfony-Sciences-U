...
use App\Security\LoginformAuthenticator as SecurityLoginformAuthenticator;
...
class RegistrationController extends AbstractController
{
    ...
    public function registrate(Request $request, UserPasswordHasherInterface $userPasswordHasher, UserAuthenticatorInterface $userAuthenticator, SecurityLoginformAuthenticator $authenticator, EntityManagerInterface $entityManager): Response
    {
